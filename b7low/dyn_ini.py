...
d0 = [113.500000 ,  44.000000 ,  40.862944] # "translation vector" from out_shift.dat
d0[0]  = NmPerAngstrom * d0[0]
d0[1]  = NmPerAngstrom * d0[1]
d0[2]  = NmPerAngstrom * d0[2]
mhc_x0 = NmPerAngstrom * -87.1613451 # start position from out_get_pos.dat
tcr_x0 = NmPerAngstrom * 86.5348816  # centroid pos tcr hold_atom from out_get_pos.dat
